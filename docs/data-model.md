...
| **Quota groups** (manager quota management) | `quota_groups`, `quota_group_quarterly_targets`, `users.quota_group_id` (FK, nullable, ON DELETE SET NULL) | `032_quota_groups.sql`, `055_quota_group_quarterly_targets.sql`, `056_add_user_quota_group.sql` |

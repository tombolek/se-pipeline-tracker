...
export default function OfflineUnavailable({ label, hint }: Props) {
  return (
    <div className="flex-1 flex items-center justify-center px-6 py-16 bg-gray-50 dark:bg-ink-2">
      <div className="max-w-md text-center">
        <div className="w-14 h-14 rounded-2xl bg-brand-purple/10 dark:bg-accent-purple-soft border border-brand-purple/20 flex items-center justify-center mx-auto mb-4">
          <svg className="w-7 h-7 text-brand-purple dark:text-accent-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 5.636A9 9 0 005.636 18.364M5.636 5.636l12.728 12.728" />
          </svg>
        </div>
        <h2 className="text-base font-semibold text-brand-navy dark:text-fg-1">{label} isn't available offline</h2>

...
const STAGE_STYLES: Record<string, { chip: string; dot: string }> = {
  ...
  'Proposal Sent':         { chip: 'bg-blue-50 text-blue-700 dark:bg-status-d-info-soft dark:text-status-d-info',               dot: 'bg-blue-400 dark:bg-status-d-info' },
  'Submitted for Booking': { chip: 'bg-amber-50 text-amber-800 dark:bg-status-d-warning-soft dark:text-status-d-warning',       dot: 'bg-amber-500 dark:bg-status-d-warning' },
  'Negotiate':             { chip: 'bg-orange-50 text-orange-700 dark:bg-status-d-warning-soft dark:text-status-d-warning',     dot: 'bg-orange-400 dark:bg-status-d-warning' },
  'Closed Won':            { chip: 'bg-emerald-50 text-emerald-800 dark:bg-status-d-success-soft dark:text-status-d-success',   dot: 'bg-emerald-500 dark:bg-status-d-success' },
};

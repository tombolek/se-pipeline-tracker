      ...
      <div className="mb-5 bg-white rounded-2xl border border-brand-navy-30/40 p-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            disabled={generatingSummary || counts.active === 0}
        ...
        {summary ? (
          ...
          <p className="mt-2 text-xs text-brand-navy-30">
            Click Generate Summary for an AI-powered analysis of common themes, deployment risks, and patterns across all active blockers.
          </p>
        )}
      </div>

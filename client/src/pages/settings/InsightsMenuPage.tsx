  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-brand-navy">Menu Settings</h1>
          <p className="text-sm text-brand-navy-70 mt-0.5">Reorder and show/hide items in the sidebar navigation</p>
        </div>
        <button
      ...
      <div className="space-y-8">
        {/* Main menu section */}
        <div>
          <h2 className="text-sm font-semibold text-brand-navy mb-2">Main menu</h2>
          <DraggableList items={mainItems} onUpdate={updateMain} />
        </div>

        {/* Insights section */}
        <div>
          <h2 className="text-sm font-semibold text-brand-navy mb-2">Insights</h2>
